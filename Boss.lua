...
UserBotLogin = "@"..Redis:get(SshId.."Info:Redis:Token:User")
local Run = io.open("run", 'w')
Run:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S ]]..UserBotLogin..[[ -X kill
screen -S ]]..UserBotLogin..[[ sudo lua5.3 Boss.lua
done
]])
Run:close()
...
chmod +x ./run
rm -fr .CallBack-Bot
cp -a ../BOSS ../]]..UserBotLogin..[[ &&
rm -fr Information.lua
rm -fr run
../]]..UserBotLogin..[[/run
]]
os.execute(CmdRun)
...
Boss = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..Boss)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Boss,token=Token}
function var(value)  
...
Status = 0
DevelopersQ = Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(Boss.."Boss:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(Boss.."Boss:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Boss.."Boss:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Boss.."Boss:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Boss.."Boss:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Boss.."Boss:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 819385837 then
Status = 'مبرمج السورس'
elseif UserId == 346252071 then
Status = 'مطور السورس'
elseif UserId == Sudo_Id then  
...
Status = Redis:get(Boss.."Boss:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(Boss.."Boss:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Boss.."Boss:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Boss.."Boss:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Boss.."Boss:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Boss.."Boss:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Boss.."Boss:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Boss.."Boss:lockpin"..ChatId) then    
lock_pin = "✔"
else 
lock_pin = "❌"    
end
if Redis:get(Boss.."Boss:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔"
else 
lock_tagservr = "❌"
end
if Redis:get(Boss.."Boss:Lock:text"..ChatId) then    
lock_text = "✔"
else 
lock_text = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔"
else 
lock_add = "❌ "    
end    
if Redis:get(Boss.."Boss:Lock:Join"..ChatId) == "kick" then
lock_join = "✔"
else 
lock_join = "❌ "    
end    
if Redis:get(Boss.."Boss:Lock:edit"..ChatId) then    
lock_edit = "✔"
else 
lock_edit = "❌ "    
end
if Redis:get(Boss.."Boss:Chek:Welcome"..ChatId) then
welcome = "✔"
else 
welcome = "❌ "    
end
if Redis:hget(Boss.."Boss:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Boss.."Boss:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Boss.."Boss:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Boss.."Boss:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔"
else     
flood = "❌ "     
end
if Redis:get(Boss.."Boss:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔" 
elseif Redis:get(Boss.."Boss:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Boss.."Boss:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Boss.."Boss:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔" 
elseif Redis:get(Boss.."Boss:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Boss.."Boss:Lock:Link"..ChatId) == "del" then
lock_links = "✔"
elseif Redis:get(Boss.."Boss:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔"
elseif Redis:get(Boss.."Boss:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Boss.."Boss:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔"
elseif Redis:get(Boss.."Boss:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔"
elseif Redis:get(Boss.."Boss:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:vico"..ChatId) == "del" then
lock_muse = "✔"
elseif Redis:get(Boss.."Boss:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Boss.."Boss:Lock:Video"..ChatId) == "del" then
lock_ved = "✔"
elseif Redis:get(Boss.."Boss:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Channel"..ChatId) == "del" then
lock_ch = "✔"
else
lock_ch = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔"
elseif Redis:get(Boss.."Boss:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔"
elseif Redis:get(Boss.."Boss:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:geam"..ChatId) == "del" then
lock_geam = "✔"
elseif Redis:get(Boss.."Boss:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Boss.."Boss:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔"
elseif Redis:get(Boss.."Boss:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Boss.."Boss:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Boss.."Boss:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔"
elseif Redis:get(Boss.."Boss:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Boss.."Boss:Lock:Document"..ChatId) == "del" then
lock_file = "✔"
elseif Redis:get(Boss.."Boss:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Boss.."Boss:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔"
elseif Redis:get(Boss.."Boss:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔"
elseif Redis:get(Boss.."Boss:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Boss.."Boss:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔"
elseif Redis:get(Boss.."Boss:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Boss.."Boss:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔"
elseif Redis:get(Boss.."Boss:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Boss.."Boss:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Boss.."Boss:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(Boss.."Boss:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Boss.."Boss:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Boss.."Boss:SilentGroup:Group"..ChatId,UserId)
}
end
function Reply_Status(UserId,TextMsg)
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.username then
UserInfousername = '['..FlterName(UserInfo,10)..'](t.me/'..UserInfo.username..')'
else
UserInfousername = '['..FlterName(UserInfo,10)..'](tg://user?id='..UserId..')'
end
return {
Lock     = TextMsg..'\n- بواسطه ⋙「 '..UserInfousername..' 」',
unLock   = TextMsg..'\n- بواسطه ⋙「 '..UserInfousername..' 」',
lockKtm  = TextMsg..' بالكتم\n- بواسطه ⋙「 '..UserInfousername..' 」',
lockKid  = TextMsg..' بالتقييد\n- بواسطه ⋙「 '..UserInfousername..' 」',
lockKick = TextMsg..' بالطرد\n- بواسطه ⋙「 '..UserInfousername..' 」',
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,Boss).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(Boss..'Boss:Channel:Join')
if Channel then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = (Redis:get(Boss..'Boss:Channel:JoinTitle') or 'اضغط للاشتراك'), url = 't.me/'..Redis:get(Boss..'Boss:Channel:Join')}, },}}
if ChannelJoin.result.user.username then
usernameinfo = 't.me/'..ChannelJoin.result.user.username
else
usernameinfo = 'tg://user?id='..msg.sender.user_id
end
LuaTele.sendText(msg.chat_id,msg.id,'◉︙عزيزي : ['..FlterName(ChannelJoin.result.user,15)..']('..usernameinfo..')\n- عليك الاشتراك في قناة البوت اسفل .',"md",true, false, false, false, reply_markup)
JoinChannel = false
end
end
return JoinChannel
...
Name = tostring(Name)
Name = utf8.gsub(Name,"[🤚🔕♠🤗😇💂🌶🤣🚹⛸⚠😅🍕🍛🧝🌿💛#😕🧞*1032547🥌98🎡🎋🏼🎰🤑🚮☠🥜⃣🛌🌙🚙👏🛍💑⛳🏌🍢👲🔡❤🐀😨🥁🦇🏣㊗💰🚒🌟🐾🦅🐃🐷🤲🎩📳🇼🍎👛◻💻➗🔪🎂🌪🔔🍊✊🐚🍽🍫❗🚴🎒♏🧢🍁🌓😸🍦󠁢😶🗓🐡🛠✏😉🎯🍋🎟🔳🌨🎱💟⛏🤳📆🔅🍴📲🥊🖍🌡📬🆑🐇🗺😾🕰📵🏈🇮🍥➰🤠👥🕥😃😤😔🐹🎬⌛💎☃📖🔨👫🙄🥒⚜🏫🥃🍘🥥📍🦕💜🗝🙃🕤🐯👤🧔🏭🚭🚘💒🐓👁🤾🏐🏮🚋🌾📗🥈📚🤧🏃〰👱🔧🥖🇾☘🔘🔙⚗🛡🏖💹🉑🚛💩🛏♋🔸💴⏬✋👷😞☎🦂�
...
local msg_id = msg.id
local text = nil
if msg.sender.luatele == "messageSenderChat" then  -- القناه
local Channel_Grouo = Redis:get(Boss.."Boss:Lock:Channel"..msg_chat_id)
if Channel_Grouo == "del" then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
print('This is Channel')
return false
end 
...
if tonumber(msg.sender.user_id) == tonumber(Boss) then
...
if tonumber(msg.sender.user_id) == 819385837 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 346252071 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(Boss.."Boss:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Boss.."Boss:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Boss.."Boss:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Boss.."Boss:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Boss.."Boss:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(Boss.."Boss:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Boss.."Boss:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Boss.."Boss:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Boss.."Boss:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Boss.."Boss:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Boss.."Boss:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Boss.."Boss:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Boss.."Boss:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Boss) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Boss.."Boss:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Boss.."Boss:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Boss.."Boss:Status:Welcome"..msg_chat_id) then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Boss) then
return false
end
local floods = Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Boss.."Boss:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Boss.."Boss:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Boss.."Boss:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Boss.."Boss:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Boss.."Boss:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Boss.."Boss:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Boss.."Boss:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Boss.."Boss:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Boss.."Boss:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(Boss.."Boss:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Boss.."Boss:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Boss.."Boss:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Boss.."Boss:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Boss.."Boss:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Boss.."Boss:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Boss.."Boss:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Boss.."Boss:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Boss.."Boss:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Boss.."Boss:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(Boss.."Boss:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Boss.."Boss:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Boss.."Boss:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Boss.."Boss:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Boss.."Boss:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Boss.."Boss:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Boss.."Boss:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Boss.."Boss:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Boss.."Boss:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Boss.."Boss:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Boss.."Boss:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[1].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Boss.."Boss:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Boss.."Boss:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Boss.."Boss:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Boss.."Boss:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Boss.."Boss:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Boss.."Boss:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Boss.."Boss:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Boss.."Boss:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Boss.."Boss:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n- ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Boss.."Boss:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Boss.."Boss:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n- تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Boss.."Boss:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Boss.."Boss:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Boss.."Boss:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Boss.."Boss:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Boss.."Boss:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Boss.."Boss:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Boss.."Boss:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Boss.."Boss:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Boss..'Boss:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Boss.."Boss:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Boss.."Boss:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Boss.."Boss:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Boss.."Boss:Command:List:Group"..msg_chat_id,text)
...
if text and Redis:get(Boss.."Boss:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Boss.."Boss:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Boss.."Boss:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
...
if text and Redis:get(Boss.."Boss:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Boss.."Boss:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,text)
Redis:del(Boss.."Boss:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(Boss.."Boss:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Boss.."Boss:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم الغاء حفظ الرابط","md",true)         
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") or text and text:match("(https://t.me/+%S+)") then     
local LinkGroup = text:match("(https://telegram.me/joinchat/%S+)") or text:match("(https://t.me/joinchat/%S+)") or text:match("(https://t.me/+%S+)")
Redis:set(Boss.."Boss:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Boss.."Boss:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Boss.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Boss.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"- تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(Boss.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Boss.."Boss:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Boss.."Boss:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Boss.."Boss:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(Boss.."Boss:Group:Rules" .. msg_chat_id,text) 
Redis:del(Boss.."Boss:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Boss.."Boss:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Boss.."Boss:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(Boss.."Boss:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Boss.."Boss:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Boss.."Boss:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Boss.."Boss:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Boss.."Boss:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Boss.."Boss:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Boss.."Boss:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Boss.."Boss:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(Boss.."Boss:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حفظ رد للمدير بنجاح \n- ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Boss.."Boss:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Boss.."Boss:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Boss.."Boss:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Boss.."Boss:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Boss.."Boss:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Boss.."Boss:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Boss.."Boss:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Boss.."Boss:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Boss.."Boss:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Boss.."Boss:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Boss.."Boss:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"↯︙ارسل لي الرد سواء كان \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩\n↯︙يمكنك اضافة الى النص •\n➖➖➖\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات","md",true)  
return false
end
end
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Boss.."Boss:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Boss.."Boss:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Boss.."Boss:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Boss.."Boss:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Boss.."Boss:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Boss.."Boss:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Boss.."Boss:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(Boss.."Boss:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Boss.."Boss:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Boss.."Boss:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Boss.."Boss:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Boss.."Boss:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Boss.."Boss:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Boss.."Boss:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Boss.."Boss:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Boss.."Boss:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Boss.."Boss:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Boss..'Boss:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Boss.."Boss:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Boss.."Boss:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Boss.."Boss:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Boss.."Boss:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Boss.."Boss:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Boss.."Boss:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Boss.."Boss:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Boss.."Boss:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Boss.."Boss:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Boss.."Boss:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Boss.."Boss:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Boss.."Boss:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Boss.."Boss:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Boss.."Boss:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Boss.."Boss:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Boss.."Boss:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Boss.."Boss:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Boss.."Boss:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Boss.."Boss:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Boss.."Boss:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Boss.."Boss:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Boss.."Boss:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Boss.."Boss:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Boss.."Boss:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,"↯︙ارسل لي الرد سواء كان \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩\n↯︙يمكنك اضافة الى النص •\n➖➖➖\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات","md",true)  
return false
end
end
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(Boss..'Boss:'..v..text)
end
Redis:del(Boss.."Boss:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Boss.."Boss:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(Boss.."Boss:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Boss.."Boss:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Boss.."Boss:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Boss.."Boss:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Boss.."Boss:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Boss.."Boss:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Boss..'Boss:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Boss.."Boss:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Boss.."Boss:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Boss.."Boss:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Boss.."Boss:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Boss..'Boss:GetTexting:DevBoss'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Boss..'Boss:GetTexting:DevBoss'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'- تم الغاء حفظ كليشة المطور')
end
Redis:set(Boss..'Boss:Texting:DevBoss',text)
Redis:del(Boss..'Boss:GetTexting:DevBoss'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'- تم حفظ كليشة المطور')
end
if Redis:get(Boss.."Boss:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تعين الايدي","md",true)  
Redis:del(Boss.."Boss:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Boss.."Boss:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Boss.."Boss:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'- تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(Boss.."Boss:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(Boss.."Boss:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Boss.."Boss:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "-  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(Boss.."Boss:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Boss.."Boss:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n- تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Boss.."Boss:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Boss.."Boss:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "-  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Boss.."Boss:Game:Smile"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Smile"..msg.chat_id) then
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Boss.."Boss:Game:Smile"..msg.chat_id)
...
if Redis:get(Boss.."Boss:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Monotonous"..msg.chat_id) then
Redis:del(Boss.."Boss:Game:Monotonous"..msg.chat_id)
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Boss.."Boss:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Riddles"..msg.chat_id) then
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Boss.."Boss:Game:Riddles"..msg.chat_id)
...
if Redis:get(Boss.."Boss:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Boss.."Boss:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Boss.."Boss:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Reflection"..msg.chat_id) then
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Boss.."Boss:Game:Reflection"..msg.chat_id)
...
if Redis:get(Boss.."Boss:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"- عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Boss.."Boss:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Boss.."Boss:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Boss.."Boss:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"- مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Boss.."Boss:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Boss.."Boss:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Boss.."Boss:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Boss.."Boss:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Boss.."Boss:Game:Difference"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Difference"..msg.chat_id) then 
Redis:del(Boss.."Boss:Game:Difference"..msg.chat_id)
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Boss.."Boss:Game:Example"..msg.chat_id) then
if text == Redis:get(Boss.."Boss:Game:Example"..msg.chat_id) then 
Redis:del(Boss.."Boss:Game:Example"..msg.chat_id)
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
tmatch = text:match('^(%S+) @(%S+)$')
if tmatch then
txt = tmatch
else
txt = text
end
local NewCmmd = Redis:get(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..txt)
if NewCmmd then
text = text:gsub(txt,NewCmmd)
end
end
...
if tonumber(Boss) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'- عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(Boss..'Boss:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Boss.."Boss:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Boss.."Boss:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Boss.."Boss:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Boss.."Boss:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Boss.."Boss:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Boss.."Boss:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(Boss) then 
return LuaTele.sendText(msg_chat_id,msg_id,'- عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(Boss.."Boss:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Boss.."Boss:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Boss.."Boss:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Boss.."Boss:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Boss.."Boss:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Boss..'Boss:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Boss..'Boss:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Boss).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n- البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Boss..'Boss:Channel:Join',ChannelUser) 
Redis:set(Boss..'Boss:Channel:JoinTitle',UserId_Info.title) 
...
Redis:set(Boss..'Boss:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Boss..'Boss:Channel:Join')
...
--os.execute( 'rm -rf Boss.lua' )
--download( 'http://  Boss.lua','Boss.lua')
...
local Groups = Redis:smembers(Boss..'Boss:ChekBotAdd')  
local UsersBot = Redis:smembers(Boss..'Boss:Num:User:Pv')  
local Get_Json = '{"BotId": '..Boss..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(Boss.."Boss:TheBasics:Group"..v)
local Constructor = Redis:smembers(Boss.."Boss:Originators:Group"..v)
local Manager = Redis:smembers(Boss.."Boss:Managers:Group"..v)
local Admin = Redis:smembers(Boss.."Boss:Addictive:Group"..v)
local Vips = Redis:smembers(Boss.."Boss:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(Boss.."Boss:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Boss.."Boss:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Boss.."Boss:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Boss.."Boss:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Boss.."Boss:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Boss.."Boss:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Boss.."Boss:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Boss.."Boss:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Boss..'Boss:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*- عدد احصائيات البوت الكامله \n➖➖➖\n- عدد المجموعات : '..(Redis:scard(Boss..'Boss:ChekBotAdd') or 0)..'\n- عدد المشتركين : '..(Redis:scard(Boss..'Boss:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(Boss.."Boss:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Boss..'Boss:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'- عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Boss..'Boss:Num:Add:Bot'),"md",true)  
end
...
{
{text = '- قفل جميع الاوامر ', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},{text = '- ترتيب الأوامر ', data =msg.sender.user_id..'/AmrGroup@'..msg_chat_id},
},
{
...
Redis:sadd(Boss.."Boss:ChekBotAdd",msg_chat_id)
Redis:set(Boss.."Boss:Status:Id"..msg_chat_id,true) ;Redis:set(Boss.."Boss:Status:Reply"..msg_chat_id,true) ;Redis:set(Boss.."Boss:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Boss.."Boss:Status:BanId"..msg_chat_id,true) ;Redis:set(Boss.."Boss:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Boss.."Boss:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Boss.."Boss:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Boss.."Boss:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Boss.."Boss:ChekBotAdd",msg_chat_id) then
Redis:incr(Boss..'Boss:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
return false
end 
if not Redis:get(Boss.."Boss:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Boss..'Boss:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Boss.."Boss:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Boss.."Boss:Set:Id:Group"..msg_chat_id)
if Redis:get(Boss.."Boss:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Boss..'Boss:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*- اسمه : '..FlterName(UserInfo,15)..
'\n- ايديه : '..UserId..
...
local TotalMsg = Redis:get(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Boss..'Boss:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*- اسمه : '..FlterName(UserId_Info,15)..
'\n- ايديه : '..UserId..
'\n- معرفه : @'..UserName..
'\n- رتبته : '..RinkBot..
'\n- رسائله : '..TotalMsg..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,Boss).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'- البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Boss).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Boss.."Boss:Developers:Groups",UserId_Info.id) then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- هذا الامر يخص { '..Controller_Num(2)..' , مالك الكروب }* ',"md",true)  
end
if not Redis:sismember(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(Boss.."Boss:Originators:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(Boss.."Boss:Managers:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(Boss.."Boss:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Boss.."Boss:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Boss.."Boss:Developers:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Boss.."Boss:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:Developers:Groups",UserId) 
...
if not Redis:sismember(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Boss.."Boss:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Boss.."Boss:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:DevelopersQ:Groups",UserId_Info.id) 
...
Redis:sadd(Boss.."Boss:Developers:Groups",UserId_Info.id) 
...
Redis:sadd(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(Boss.."Boss:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(Boss.."Boss:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Boss.."Boss:Status:SetId"..msg_chat_id) then
...
Redis:sadd(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Boss.."Boss:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Boss.."Boss:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:Developers:Groups",Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(Boss.."Boss:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Boss.."Boss:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Boss.."Boss:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:Developers:Groups",UserId) 
...
if Redis:sismember(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Boss.."Boss:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Boss.."Boss:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"- تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Boss.."Boss:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Boss.."Boss:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Boss.."Boss:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Boss.."Boss:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Boss.."Boss:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Boss.."Boss:Vip:Group:Reply"..msg.chat_id,Teext)
...
--if Redis:get(Boss.."chat:trnd"..msg.chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"- يمكنك معرفة الترند كل *5 دقائق* فقط","md",true)   end
Redis:setex(Boss..'chat:trnd'..msg.chat_id,300,true)
GroupAllRtba = Redis:keys(Boss..'Boss:Num:Message:User'..msg.chat_id..':*')
GroupAllRtbaL = {}
for kk,ids in pairs(GroupAllRtba) do 
local k = ids:match(msg.chat_id..":(%d+)")
local v = Redis:get(Boss..'Boss:Num:Message:User'..msg.chat_id..':'..k)
table.insert(GroupAllRtbaL,{v,k}) end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
Text = "- أكثر *"..Count.."* أعضاء تفاعلاً في "..(Get_Chat.title or 'المجموعة').."\n\n"
for k,v in ipairs(GroupAllRtbaL) do
if i <= Count then 
local UserInfo = LuaTele.getUser(v[2])
if i==1 then t="🥇" elseif i==2 then t="🥈" elseif i==3 then t="🥉" elseif i==4 then t="🏅" else t="🎖" end Text = Text..i.."ـ ["..(FlterName(UserInfo,20) or "خطأ بالأسـم").."](tg://user?id="..v[2]..") ـ~> {*"..v[1].."*} "..t.."\n" end ; i=i+1
end
...
Redis:set(Boss.."Boss:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Boss.."Boss:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Boss.."Boss:Status:Id"..msg_chat_id,true) 
...
Redis:set(Boss.."Boss:Status:IdPhoto"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تفعيل الايدي بالصوره ","md",true)
end
if TextMsg == 'ردود المدير' or TextMsg == 'الردود' then
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*- هذا الامر يخص { '..Controller_Num(6)..' }* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:set(Boss.."Boss:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Boss.."Boss:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Boss.."Boss:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Boss.."Boss:BotFree",true) 
...
Redis:set(Boss.."Boss:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Boss.."Boss1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Boss.."Boss1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Boss..'Boss1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Boss..'Boss1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Boss..'Boss1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Boss.."Boss1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Boss.."Boss1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Boss.."Boss1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Boss.."Boss1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Boss.."Boss1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Boss.."Boss1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Boss.."Boss1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Boss.."Boss1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Boss.."Boss1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Boss.."Boss1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Boss.."Boss1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Boss.."Boss1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Boss.."Boss1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Boss.."Boss1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Boss.."Boss1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Boss.."Boss11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Boss.."Boss11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(Boss.."Boss11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(Boss..'Boss11:Add:Rd:Sudo:Text'..text)
Redis:del(Boss..'Boss11:Add:Rd:Sudo:Text1'..text)
Redis:del(Boss..'Boss11:Add:Rd:Sudo:Text2'..text)
Redis:del(Boss.."Boss11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Boss.."Boss11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(Boss.."Boss11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Boss.."Boss11:Add:Rd:Sudo:Text"..v) 
Redis:del(Boss.."Boss11:Add:Rd:Sudo:Text1"..v) 
Redis:del(Boss.."Boss11:Add:Rd:Sudo:Text2"..v)   
Redis:del(Boss.."Boss11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Boss.."Boss11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Boss.."Boss11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Boss.."Boss11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Boss.."Boss11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Boss.."Boss11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(Boss.."Boss11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Boss.."Boss11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Boss.."Boss11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Boss.."Boss11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(Boss.."Boss:allM"..msg.chat_id, msg.id)
if Redis:get(Boss.."Boss:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Boss.."Boss:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Boss.."Boss:allM"..msg.chat_id)
...
Redis:del(Boss.."Boss:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Boss.."Boss:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Boss.."Boss:allM"..msg.chat_id)  
...
Redis:del(Boss.."Boss:Status:Del:Media"..msg.chat_id)
...
Redis:set(Boss.."Boss:Status:Del:Media"..msg.chat_id,true)
...
if TextMsg == 'الرابط' then
Redis:del(Boss.."Boss:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Boss.."Boss:Status:Welcome"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:Id"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:Reply"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:BanId"..msg_chat_id) 
...
Redis:del(Boss.."Boss:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Boss.."Boss:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Boss.."Boss:Status:KickMe"..msg_chat_id) 
...
if not Redis:sismember(Boss.."Boss:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Boss.."Boss:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Boss.."Boss:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"- تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Boss.."Boss:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Boss.."Boss:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Boss.."Boss:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Boss.."Boss:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Boss.."Boss:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Boss.."Boss:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Boss.."Boss:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Boss.."Boss:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"- تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Boss.."Boss:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"- تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(Boss.."Boss:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Boss.."Boss:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Boss.."Boss:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Boss..'Boss:GetTexting:DevBoss'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Boss..'Boss:Texting:DevBoss')
return LuaTele.sendText(msg_chat_id,msg_id,'-  تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevBoss = Redis:get(Boss..'Boss:Texting:DevBoss')
if TextingDevBoss then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevBoss,"md",true)  
else
...
data = {
{
{text = 'قناة السورس', url = 'https://t.me/czarbot1'}, 
},
{
{text = 'تواصل السورس', url = 'https://t.me/czarbot1'}, 
},
{
{text = 'مطور السورس', url = 't.me/czarbot1'}, 
},
}
}
...
Redis:setex(Boss.."Boss:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(Boss.."Boss:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"- تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(Boss.."Boss:Name:Bot") or "سيزر") then
local NamesBot = (Redis:get(Boss.."Boss:Name:Bot") or "سيزر")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(Boss..'Boss:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Boss)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*- البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(Boss..'Boss:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(Boss..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(Boss..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(Boss..'Boss:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Boss.."Boss:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Boss.."Boss:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Boss.."Boss:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Boss.."Boss:Status:Games"..msg.chat_id) then
Redis:del(Boss.."Boss:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Boss.."Boss:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Boss.."Boss:Status:Games"..msg.chat_id) then
Redis:del(Boss.."Boss:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Boss.."Boss:Game:Reflection"..msg.chat_id,name)
...
return LuaTele.sendText(msg_chat_id,msg_id, "*-  لعبه المحيبس هي لعبة الحظ \n- جرب حظك ويه البوت واتونس \n- كل ما عليك هوا الضغط على احدى العضمات في الازرار*","md",false, false, false, false, reply_markup)
end
end
if text == "خمن" or text == "تخمين" then   
if Redis:get(Boss.."Boss:Status:Games"..msg.chat_id) then
Num = math.random(1,20)
Redis:set(Boss.."Boss:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Boss.."Boss:Game:Difference"..msg.chat_id,name)
...
Redis:set(Boss.."Boss:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
local NumberGet = math.floor(NumGame * 50)
Redis:decrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Boss..'Boss:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id,NumberGet)  
return LuaTele.sendText(msg_chat_id,msg_id,"- تم خصم *~ { "..NumGame.." }* من مجوهراتك \n- وتم اضافة* ~ { "..(NumberGet).." } رساله الى رسالك *","md",true)  
end 
...
Redis:incrby(Boss.."Boss:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Boss.."Boss:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Boss.."Boss:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"ا")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"م")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"اد")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"مد")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"من")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"اس")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"مط")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"ثانوي")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"تك")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"تعط")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"تفع")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"ر")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"رر")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"،،")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"رد")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"سح")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"رس")
Redis:sadd(Boss.."Boss:Command:List:Group"..msg_chat_id,"غ")
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')

return LuaTele.sendText(msg_chat_id,msg_id,"*- تم ترتيب الاوامر بالشكل التالي ~\n-  ايدي - ا .\n-  رفع مميز - م .\n- رفع ادمن - اد .\n-  رفع مدير - مد . \n-  رفع منشى - من . \n-  رفع منشئ الاساسي - اس  .\n-  رفع مطور - مط .\n- رفع مطور ثانوي - ثانوي .\n-  تنزيل الكل - تك .\n-  تعطيل الايدي بالصوره - تعط .\n-  تفعيل الايدي بالصوره - تفع .\n-  الرابط - ر .\n-  ردود المدير - رر .\n-  مسح المكتومين - ،، .\n-  اضف رد - رد .\n-  مسح سحكاتي - سح .\n-  مسح رسائلي - رس .\n-  غنيلي - غ .*","md")
end
...
if text == '/start' then
Redis:sadd(Boss..'Boss:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Boss.."Boss:Start:Bot") then
local CmdStart = '*\n- أهلآ بك في بوت '..(Redis:get(Boss.."Boss:Name:Bot") or "سيزر")..
...
{
{text = '- قناة السورس', url = 't.me/czarbot1'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Boss.."Boss:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Boss.."Boss:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Boss.."Boss:TwaslBot") and not Redis:sismember(Boss.."Boss:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Boss.."Boss:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Boss.."Boss:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Boss..'Boss:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'- تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Boss..'Boss:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Boss.."Boss:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Boss..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Boss.."Boss:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Boss.."Boss:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Boss.."Boss:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == Boss then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(Boss..'Boss:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Boss.."Boss:Lock:edit"..data.chat_id) then
...
local NotUserId = Text:match('(%d+)')
if tonumber(NotUserId) and tonumber(IdUser) ~= tonumber(NotUserId) then
LuaTele.answerCallbackQuery(data.id, "- الأمر غير مخصص لك .", true)
end
...
Redis:incrby(Boss.."Boss:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"- تم قفـل الفيديو").Lock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/lock_channel') then
local UserId = Text:match('(%d+)/lock_channel')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Channel"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"- تم قفـل القناه").Lock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/lock_photo') then
local UserId = Text:match('(%d+)/lock_photo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Boss.."Boss:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Boss.."Boss:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Boss.."Boss:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Boss.."Boss:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Boss.."Boss:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Boss.."Boss:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Boss.."Boss:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Boss.."Boss:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Boss..'Boss:'..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "- تم قفل جميع الاوامر بنجاح  ", true)
end
end
if Text and Text:match('(%d+)/AmrGroup@(.*)') then
local UserId = {Text:match('(%d+)/AmrGroup@(.*)')}
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"ا")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"م")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"اد")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"مد")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"من")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"اس")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"مط")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"ثانوي")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"تك")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"تعط")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"تفع")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"ر")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"رر")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"،،")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"رد")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"سح")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"رس")
Redis:sadd(Boss.."Boss:Command:List:Group"..UserId[2],"غ")
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(Boss.."Boss:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
LuaTele.answerCallbackQuery(data.id, "- تم ترتيب الأوامر بنجاح  ", true)
end
end
...
{
{text = GetSetieng(ChatId).lock_ch, data = '&'},{text = 'القناه : ', data =IdUser..'/'.. 'Status_channel'},
},
{
...
return LuaTele.editMessageText(ChatId,Msg_id,"*- تم اخفاء الأوامر .*", 'md', true, false, reply_markup)
end
end
...
elseif Text and Text:match('(%d+)/Status_channel') then
local UserId = Text:match('(%d+)/Status_channel')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
{text = 'قفل القناه', data =UserId..'/'.. 'lock_channel'},{text = 'فتح القناه', data =UserId..'/'.. 'unlock_channel'},
},
{
{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},
},
...
LuaTele.editMessageText(ChatId,Msg_id,"- عليك اختيار نوع القفل او الفتح على امر القناه", 'md', true, false, reply_markup)
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"- تم فتح الفيديو").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_channel') then
local UserId = Text:match('(%d+)/unlock_channel')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Channel"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"- تم فتح القناه").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unlock_photo') then
local UserId = Text:match('(%d+)/unlock_photo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Boss.."Boss:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"- تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Boss.."Boss:SilentGroup:Group"..ChatId) 
